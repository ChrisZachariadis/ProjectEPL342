    ...
    <div class='col-md-12'>
      <div id='Products' class='home-container1 items'>
          <div class='home-container2 items'>
            ...
            <button type='submit' class='home-button button'>Edit</button>
            </form>
          </div>
          </div>
    </div>
...
<body>
    ...
    if($_SESSION['UserType'] == 'Admin'){
        ...
        <button type="submit" class="home-button4 button">Add Product</button>
      </form>';
    }
    ?>
    ...
    <div style="background-color: #D9D9D9">
        ...
        <div class="home-container">
            <h1 id="TITLE" class="home-text">!Your Products!</h1>
            <div class="container">
